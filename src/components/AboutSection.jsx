...
function AboutSection() {
  return (
    <section id="about" className="w-full bg-white py-10 px-10 flex flex-col items-center justify-center font-lato">
      <div className="w-full max-w-[1200px] flex flex-col md:flex-row items-center justify-between gap-0 md:gap-12 px-8 md:px-0">
        {/* Left: Text */}
        <div className="flex-1 flex flex-col items-start justify-center w-full max-w-[600px]">
          ...
          <button className="mt-6 bg-black text-white text-base font-semibold rounded-none px-10 py-3 hover:bg-opacity-90 transition">Express Your Interest</button>
        </div>
        {/* Right: Image */}

...
function QueriesSection() {
  return (
    <section className="w-full flex flex-col items-center justify-center py-12 bg-white">
      <div className="max-w-6xl mx-auto px-4 w-full flex items-center justify-center">
        <div className="relative rounded-2xl min-h-[380px] w-[90vw] max-w-6xl overflow-hidden flex flex-row shadow-lg" style={{margin: '0 0'}}>
          ...
          <div className="relative z-20 flex flex-col justify-center min-h-[260px] w-1/2 pl-12 pr-6 py-10">
            ...
            <div className="mb-6">
              <p className="font-extrabold text-black text-lg md:text-2xl mb-2">Raveena Kumari</p>
              <p className="font-bold text-black text-base md:text-xl mb-2">+91 6202557868</p>
              <p className="font-bold text-black text-base md:text-xl">raveena@observenow.co.in</p>
            </div>
            <div className="mt-6">
              <a href="#contact" className="bg-black text-white px-7 py-3 rounded font-semibold w-[220px] text-base whitespace-nowrap block text-center transition-all duration-200 hover:bg-[#222] active:scale-95 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2">Express Your Interest</a>
            </div>
          </div>
        </div>
      </div>
